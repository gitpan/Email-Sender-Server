...
package Email::Sender::Server::Schema::Result::Log;
{
    $Email::Sender::Server::Schema::Result::Log::VERSION = '0.01_01';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NDD29+1kvcx34YLlz4fnSQ
