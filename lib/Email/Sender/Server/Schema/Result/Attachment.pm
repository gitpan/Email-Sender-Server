...
package Email::Sender::Server::Schema::Result::Attachment;
{
    $Email::Sender::Server::Schema::Result::Attachment::VERSION = '0.01_01';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PHlDkKX8DDc/sCHWTuPdWQ
